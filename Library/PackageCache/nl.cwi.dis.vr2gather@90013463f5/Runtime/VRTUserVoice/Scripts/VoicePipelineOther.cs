...
namespace VRT.UserRepresentation.Voice
{
    ...
    public class VoicePipelineOther : MonoBehaviour
    {
        ...
        public bool audioLevelDebugging = true;
...
#if VRT_WITH_STATS
            stats.statsUpdate(data.Length/channels, nZeroSamplesInserted, currentTimestamp, preparer.getQueueDuration(), currentAudioLevel);
#endif
        }
        ...
        protected class Stats : Statistics
        {
            ...
            double statsTotalAveragePower = 0;

            public void statsUpdate(int nSamples, int nZeroSamples, Timestamp timestamp, Timedelta queueDuration, float averagePower)
            {
